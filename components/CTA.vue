	...
	<div class="cta py-20 bg-cc-main text-white text-center items-center relative">
		<div class="container mx-auto relative">
			...
			<div class="group mt-6">
				...
				<br />
				<a href="https://wordpress.org/plugins/custom-codes/" aria-label="Download free version" target="_blank" class="text-white text-opacity-50 background-transparent font-bold uppercase px-3 py-1 text-xs mr-1 mt-3 transition hover:text-opacity-100 inline-flex items-center" role="button">
