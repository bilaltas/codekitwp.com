	...
	<header role="banner">
		<div class="container mx-auto flex items-center justify-between">
			...
			<nav class="w-auto grid grid-flow-col items-center gap-3 md:gap-3 mt-0" role="navigation" itemscope="itemscope" itemtype="http://www.schema.org/SiteNavigationElement">
				...
				<button aria-label="Open Menu" title="Open Menu" class="inline-flex md:hidden text-gray-500 focus:outline-none hover:bg-transparent hover:text-gray-900" @click="$store.commit('setMenu', true)">
		...
		<div v-if="$store.state.isMenuOpen" class="absolute top-0 left-0 w-full z-50" role="navigation">
			<div class="pt-5 bg-white border-t border-transparent shadow-sm">
				<div class="flex items-center justify-between mb-4 px-6">
					...
					<div>
						<button aria-label="Close Menu" title="Close Menu" class="p-2 -mt-2 -mr-2 transition duration-200 rounded text-gray-500 hover:bg-transparent hover:text-gray-900 focus:outline-none focus:shadow-outline" @click="$store.commit('setMenu', false)">
