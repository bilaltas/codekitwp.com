	...
	<header>
		<div class="container mx-auto flex items-center justify-between">
			...
			<nav class="w-auto grid grid-flow-col items-center gap-3 md:gap-3 mt-0">
				...
				<button href="#" class="inline-flex md:hidden text-gray-500 focus:outline-none hover:bg-transparent hover:text-gray-900" aria-label="Open Menu" title="Open Menu" @click="isMenuOpen = true">
