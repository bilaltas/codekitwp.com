<template>
	<div class="feature-section justify-center text-center">
		<span class="font-mono uppercase rounded-full text-gray-200 py-1 px-4 text-sm inline-flex font-semibold">Features</span>
		<h2 class="text-heading text-gray-900 tracking-tight font-bold">The most powerful integrated IDE</h2>
