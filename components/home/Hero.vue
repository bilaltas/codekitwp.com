	...
	<div class="hero home relative overflow-hidden">
		<div class="container mx-auto py-20 lg:py-40 grid grid-cols-1 lg:grid-cols-2 gap-4">
			<div class="w-full relative">
				...
				<a href="https://wordpress.org/plugins/custom-codes/" target="_blank" class="text-white text-opacity-40 background-transparent font-bold uppercase px-3 py-1 text-xs transition hover:text-opacity-100 inline-flex items-center">
