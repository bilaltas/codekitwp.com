<template>
	<section id="testimonials" class="testimonials py-14 lg:py-24">
		<div class="container mx-auto">
			<div class="section-title text-center mb-10">
				...
				<h3 class="text-3xl xl:text-section text-gray-900 font-semibold tracking-tight leading-tight">Trusted by 3000+ WordPress Users</h3>
