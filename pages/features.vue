<template>
	<div>
		...
		<section id="core" class="relative bg-gray-50 py-16 sm:py-20 md:pt-32 md:pb-28 text-left overflow-hidden">
			<div class="container mx-auto">
				<div class="flex flex-row">
					<div class="flex-1">
						...
						<h2 class="font-medium text-4xl leading-tight tracking-tight">
		...
		<section id="pro" class="relative bg-white py-16 sm:py-20 md:pt-32 md:pb-28 text-left overflow-hidden">
			<div class="container mx-auto">
